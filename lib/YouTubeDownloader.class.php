...
class YouTubeDownloader
{
    ...
    private function getVideoInfo()
    {
        ...
        $vid = $this->extractVideoId($this->video_url);
        return file_get_contents("https://www.youtube.com/get_video_info?html5=1&video_id=" . $vid . "&eurl=https%3A%2F%2Fyoutube.googleapis.com%2Fv%2F" . $vid . "&c=TVHTML5&cver=6.20180913");
    }
